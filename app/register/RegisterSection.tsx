...
export default function RegisterSection() {
  ...
  return (
    <section className="w-full bg-[#F8FAFC] flex items-center justify-center p-4 sm:p-6 lg:p-12 font-sans antialiased">
      ...
      <div className="w-full max-w-5xl rounded-[28px] overflow-hidden shadow-2xl bg-[#1E293B] grid grid-cols-1 md:grid-cols-12 min-h-[580px] relative">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0F172A] tracking-tight">
                Create your Zoiko account.
              </h2>
              <p className="text-sm text-[#4D5E72] leading-relaxed">
                Start building structured global payroll with explicit authority controls.
              </p>
            </div>
