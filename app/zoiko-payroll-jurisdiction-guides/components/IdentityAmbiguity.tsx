      ...
      <div className="w-full flex items-center justify-center gap-14">
        ...
        <div className="w-[541px] flex flex-col items-start gap-3.5">
          <div className="w-full h-5 relative">
            <div className="w-4 h-0.5 absolute bg-blue-600 mt-[7.90px]" />
            <div className="absolute left-[24px] top-[-1.40px] text-blue-600 text-xs font-bold uppercase leading-5 tracking-wide">
          ...
          <div className="w-full h-16 relative mt-2">
            <div className="absolute left-0 top-[6.39px] h-6 px-2 py-[3px] bg-slate-50 rounded-md outline outline-1 outline-offset-[-1px] outline-slate-200 flex items-center">
              <span className="text-slate-500 text-xs font-mono leading-4">Canonical name</span>
            </div>
            <div className="absolute left-[118px] top-[6.39px] h-6 px-2 py-[3px] bg-slate-50 rounded-md outline outline-1 outline-offset-[-1px] outline-slate-200 flex items-center">
              <span className="text-slate-500 text-xs font-mono leading-4">Type + parent/region</span>
            </div>
            <div className="absolute left-[274px] top-[6.39px] h-6 px-2 py-[3px] bg-slate-50 rounded-md outline outline-1 outline-offset-[-1px] outline-slate-200 flex items-center">
              <span className="text-slate-500 text-xs font-mono leading-4">Approved aliases only</span>
            </div>
            <div className="absolute left-0 top-[40.66px] h-6 px-2 py-[3px] bg-slate-50 rounded-md outline outline-1 outline-offset-[-1px] outline-slate-200 flex items-center">
              <span className="text-slate-500 text-xs font-mono leading-4">Verified codes only</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-[500px] h-80 relative">
          <div className="w-[500px] h-80 rounded-[20px] bg-gradient-to-br from-slate-100 to-slate-200 overflow-hidden">
            <Image src="/abb.png" alt="Identity resolver" width={500} height={320} className="w-full h-80 object-cover rounded-[20px]" />
          </div>
