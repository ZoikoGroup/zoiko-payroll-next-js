...
const areas = [
  ...
  },
  {
    ...
    count: "26 releases",
    href: "/reporting",
    authority: { label: "Current Reporting", href: "/reporting" },
  },
  {
    title: "Integrations",
  ...
  },
  {
    ...
    count: "12 releases",
    href: "/security",
    authority: { label: "Security & Trust evidence", href: "/security" },
  },
  {
    ...
    count: "9 releases",
    href: "/implementation",
    authority: { label: "Current Implementation", href: "/implementation" },
  },
  {
    title: "Global Payroll",
    description: "Verified jurisdiction scope only — never inferred availability.",
    count: "15 releases",
    href: "/zoiko-global-payroll-overview",
  },
];
