...
const scenarios = [
  { title: "New hires", desc: "Structured onboarding, first-cycle setup and\nidentity verification — ready before day one.", tag: "Pre-start pathway", tagDot: "bg-sky-600", image: "/a.png" },
  { title: "Domestic & international relocation", desc: "Currency, tax residency and entity reassignment\nhandled without a payroll gap.", tag: "Flexible effective dates", tagDot: "bg-green-600", image: "/b.png" },
  { title: "Temporary assignments & secondments", desc: "Defined start and end dates, with a clear,\naccountable exit from payroll.", tag: "Fixed-term stay", tagDot: "bg-yellow-600", image: "/cc.png" },
  { title: "Projects & rotations", desc: "Multi-entity work with clean, traceable handovers\nbetween assignments.", tag: "Cross-entity ready", tagDot: "bg-sky-600", image: "/d.png" },
  { title: "Seasonal workforces", desc: "Peak-period capacity with predictable, short-cycle\ncosts.", tag: "Rapid start", tagDot: "bg-green-600", image: "/e.png" },
  { title: "Trainees, apprentices & contractors", desc: "Lower budgets, defined pay programs, and no\nperformance or productivity scoring.", tag: "No performance data", tagDot: "bg-gray-400", image: "/f.png" },
];
          ...
          {scenarios.map((s) => (
            <div key={s.title} className="w-full bg-white rounded-2xl shadow-[0px_1px_2px_0px_rgba(8,47,73,0.04)] outline outline-1 outline-offset-[-1px] outline-slate-100 flex flex-col overflow-hidden">
              ...
              <div className="px-5 py-5 flex flex-col gap-2">
                ...
                <div className="pb-2.5 text-gray-400 text-xs leading-5 whitespace-pre-line">{s.desc}</div>
                <div className="w-36 h-7 bg-slate-50 rounded-[20px] outline outline-1 outline-offset-[-1px] outline-slate-100 flex items-center gap-2 px-3">
                  <span className="text-sky-950 text-sm font-bold leading-4">•</span>
