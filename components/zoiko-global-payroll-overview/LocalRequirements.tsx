      ...
      <div className="w-full max-w-[1180px] mx-auto px-8 flex flex-col items-start gap-11">
        ...
        <div className="w-[680px] max-w-[680px] pt-[1.63px] flex flex-col items-start">
          <div className="w-96 h-5 relative">
            <div className="absolute left-[0px] top-[-1px] text-sky-700 text-xs font-extrabold uppercase leading-5 tracking-wide">
          ...
          <div className="pt-3.5 text-sky-950 text-4xl font-extrabold leading-10 whitespace-nowrap">
            Requirement → configuration → review<br/>→ evidence.
          </div>
          <div className="w-[640px] max-w-[640px] text-slate-600 text-base leading-6">
            Zoiko does not offer legal advice or claim automatic compliance. It gives payroll<br/>and compliance teams a consistent, traceable way to manage local<br/>requirements.
          </div>
        </div>
        ...
        <div className="w-full flex items-start gap-5">
            ...
            <div className="grid grid-cols-2 gap-2">
              {requirements.map((r) => (
                <div key={r} className="h-10 py-2.5 border-b border-slate-100 flex items-center gap-2.5">
                  <Image src="/tick.svg" alt="tick" width={14} height={14} className="w-3.5 h-3.5" />
          ...
          <div className="flex-1 bg-white rounded-2xl shadow-[0px_1px_2px_0px_rgba(8,47,73,0.04)] outline outline-1 outline-offset-[-1px] outline-slate-100 overflow-hidden">
            <div className="w-full h-48 overflow-hidden">
              <Image src="/tt.png" alt="Compliance workflow" width={539} height={359} className="w-full h-full object-cover" />
            </div>
