const stats = [
  ...
  { title: "Jurisdiction status", badge: "Current", badgeBg: "bg-green-500/20", badgeText: "text-green-300", value: "14", desc: "Availability, service model and effective date\ntracked per market.", barW: "w-full", barColor: "bg-blue-500" },
  ...
  { title: "Approvals", badge: "On schedule", badgeBg: "bg-green-500/20", badgeText: "text-green-300", value: "92%", desc: "Required stage, authorized role and decision\nstatus.", barW: "w-64", barColor: "bg-green-500" },
      ...
      <div className="w-full max-w-[1180px] mx-auto px-8 flex flex-col items-start gap-11">
        ...
        <div className="w-[680px] max-w-[680px] pt-[1.62px] flex flex-col items-start gap-2">
          ...
          <div className="w-[640px] max-w-[640px] text-slate-600 text-base font-normal font-['Inter'] leading-6">
            Executive orientation and operational evidence in a single frame. All data below<br/>is synthetic, shown for illustration only.
          </div>
        </div>
        ...
        <div className="w-full p-10 bg-cyan-950 rounded-[20px] flex flex-col items-start gap-7 overflow-hidden relative">
          ...
          {/* Stats grid */}
          <div className="w-full grid grid-cols-3 gap-[14px] relative z-10">
            {stats.map((s) => (
              <div key={s.title} className="w-full p-5 bg-white/5 rounded-2xl outline outline-1 outline-offset-[-1px] outline-white/10 backdrop-blur-[1px] flex flex-col gap-1">
                <div className="flex items-center justify-between">
                  ...
                  <div className={`px-2 h-[15px] rounded-[20px] ${s.badgeBg} flex items-center`}>
                ...
                <div className="pb-2 text-[#9FB9CB] text-xs leading-4 whitespace-pre-line">{s.desc}</div>
