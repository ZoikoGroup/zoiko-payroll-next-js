      ...
      <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        <Reveal>
          <Eyebrow tone="light" center>
            Ready to move payroll without losing control?
          </Eyebrow>
          <h2 className="mx-auto mt-6 max-w-2xl text-3xl font-extrabold leading-tight text-white">
            See your migration scope inside the Control Center
          </h2>
          <p className="mx-auto mt-5 max-w-xl text-base leading-6 text-white/70">
            A guided walkthrough of scope, mapping, reconciliation and cutover gates — mapped to
            your entities and sources.
          </p>

          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <Link
              href="/book-a-demo"
              className="flex min-h-11 items-center justify-center rounded-lg bg-gradient-to-b from-[#3196D6] to-[#0E7CC5] px-6 py-3 text-sm font-semibold text-white transition-all duration-200 hover:-translate-y-0.5"
            >
              Book a demo{" "}
