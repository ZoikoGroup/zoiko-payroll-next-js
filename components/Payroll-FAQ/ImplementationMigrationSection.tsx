...
const migrationFaqData: MigrationFAQItem[] = [
  {
    id: 1,
...
export const ImplementationMigrationSection: React.FC = () => {
      ...
      <div className="max-w-[1200px] mx-auto space-y-8">
        ...
        <div className="space-y-3">
          ...
          <h2 className="text-sky-950 text-3xl font-extrabold leading-tight">
            Readiness questions, answered without<br className="hidden sm:inline" />
            inventing your program.
          </h2>
        </div>

        {/* Accordion List Container */}
        <div className="space-y-3">
          {migrationFaqData.map((item) => {
                ...
                {isOpen && (
                  <div className="px-5 pb-5 pt-1 border-t border-slate-200 space-y-4">
                    ...
                    {item.detail ? (
                      ...
                      <p className="text-gray-600 text-xs leading-relaxed">
                        Refer to our implementation guidelines for step-by-step migration protocols, cutover checklists, and validation requirements.
                      </p>
                    )}

                    {/* Metadata Footer & Link Action */}
