...
const continuedNavItems: NavigationItem[] = [
...
export default function ContinuedSidebar() {
  const [activeId, setActiveId] = useState<string>("duration-governance");

  useEffect(() => {
    const handleScroll = () => {
      const scrollPosition = window.scrollY + 200;

      for (const item of continuedNavItems) {
