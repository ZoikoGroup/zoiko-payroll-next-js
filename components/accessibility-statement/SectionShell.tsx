...
/**
 * Shared frame for every Accessibility Statement section: centred 856px
 * content column, section heading, optional intro line and a hairline divider.
 */
export default function SectionShell({
  ...
  return (
    <section
      ...
      className={`w-full bg-white ${last ? "" : "border-b border-slate-200"}`}
    >
