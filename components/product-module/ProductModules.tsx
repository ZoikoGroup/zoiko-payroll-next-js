...
const modules = [
  {
    ...
    description: (
      <>
        Prepare, calculate, validate and
  ...
  },
  {
    ...
    description: (
      <>
        Make review stages and decision
        <br className="hidden sm:block" />
        rights visible.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Control recurring, one-time and
        <br className="hidden sm:block" />
        corrective changes.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Provide secure access to applicable
        <br className="hidden sm:block" />
        pay information.
      </>
    ),
      ...
      >
        ...
        >
          <h2
            ...
            "
          >
            Run and control the core payroll cycle.
          </h2>
        </div>
