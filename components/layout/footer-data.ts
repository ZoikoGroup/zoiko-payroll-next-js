...
export const footerLinkColumns: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "HR and people teams", href: "/hr-teams" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Local payroll requirements", href: "/payroll-requirements" },
      ...
      { label: "Global implementation", href: "/implementation-migration" },
