...
export default function IntegrationsReadyCta() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Heading */}
        <div
          className={`w-full max-w-[640px] transition-all duration-700 ${
            isVisible
              ? "translate-y-0 opacity-100"
              : "translate-y-5 opacity-0"
          }`}
        ...
        >
          <h2 className="text-center font-['Inter'] text-2xl font-extrabold leading-9 text-white sm:text-3xl sm:leading-10">
            Explore integrations, or talk to our team.
          </h2>
        </div>

        {/* Buttons */}
        <div
          className={`flex w-full flex-wrap justify-center gap-3.5 pt-3 transition-all duration-700 ${
            isVisible
              ? "translate-y-0 opacity-100"
              : "translate-y-5 opacity-0"
          }`}
