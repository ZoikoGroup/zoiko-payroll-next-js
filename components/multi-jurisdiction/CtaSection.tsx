...
const links = [
  { label: "Global Payroll Control Center", href: "#global-control-center" },
  { label: "Jurisdiction coverage", href: "#jurisdiction-coverage" },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <div className="relative overflow-hidden rounded-2xl bg-[#123A5E] px-8 py-12 sm:px-10">
            <img
              src="/images/multi-jurisdiction/cta-bg.png"
              alt=""
              aria-hidden="true"
            ...
            <div className="relative flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
              <div>
                <h2 className="text-xl font-extrabold leading-8 break-words sm:text-2xl sm:leading-10 text-white">
                  One Global Control Layer.
                  <br />
                  Locally Accountable Payroll.
                </h2>
                <p className="mt-3 max-w-md text-sm leading-6 text-white/70">
                  See how Zoiko Payroll keeps every market visible, governed and evidenced — without
                  pretending every market works the same way.
                </p>
