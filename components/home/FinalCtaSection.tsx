        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8">
          <Reveal>
            ...
            <Link
              ...
              className="group mt-6 inline-flex items-center gap-1.5 text-sm font-semibold text-white underline decoration-white/40 underline-offset-4 transition-colors duration-200 hover:decoration-white"
            >
            ...
            <form className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <select name="jurisdiction" defaultValue="United States" className={inputClass}>
